...
public class ExpenseContract implements BaseColumns {
    ...
    public static final String GROUP_TYPE  = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.jonathanfinerty.liquid.expense";

    public static final String SINGLE_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.jonathanfinerty.liquid.expense";
